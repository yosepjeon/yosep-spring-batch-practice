...
public class StepNextConditionalJobConfiguration {
	...
	public Step conditionalJobStep1() {
		return stepBuilderFactory.get("conditionalJobStep1").tasklet((contribution, chunkContext) -> {
			log.info(">>>>> This is stepNextConditionalJob Step1");

			/*
			 * ExitStatus FAILED로 지정한다. 해당 status를 보고 flow가 진행된다.
			 */
